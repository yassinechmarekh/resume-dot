    ...
    education: [
      {
        ...
        degree: "B.TECH",
        field: "CSE",
        graduation_date: new Date("2023-05-01"),
      },
      {
        institution: "Example Public School",
        degree: "HIGHER SECONDARY",
        field: "PCM",
        graduation_date: new Date("2019-03-01"),
      },
      {
        institution: "Example Academy",
        degree: "SECONDARY SCHOOL",
        field: "",
        graduation_date: new Date("2017-03-01"),
      },
    ],
    ...
    education: [
      {
        ...
        graduation_date: new Date("2018-06-01"),
      },
      {
        institution: "Lincoln High School",
        degree: "High School Diploma",
        field: "Science",
        graduation_date: new Date("2014-05-01"),
      },
    ],
    template: "minimal-image",
    accent_color: "#6366F1",
    ...
    education: [
      {
        ...
        graduation_date: new Date("2016-05-01"),
      },
      {
        institution: "Central High School",
        degree: "High School Diploma",
        field: "Science",
        graduation_date: new Date("2012-04-01"),
      },
    ],
    template: "minimal-image",
    accent_color: "#F59E0B",
